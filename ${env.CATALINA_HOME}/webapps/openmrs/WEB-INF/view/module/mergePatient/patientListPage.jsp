		...
		<Table>
			<tr>
				...
				<td><input name="searchButton" id="searchPatient" type="submit"
					value='<spring:message code="@MODULE_ID@.mergePatient.searchBtn" />'></td>
			</tr>
		</Table>
	</form>
