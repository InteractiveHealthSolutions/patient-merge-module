...
public class SearchPatientController extends SimpleFormController {
	...
	protected ModelAndView processFormSubmission(HttpServletRequest request, HttpServletResponse response, Object command,
		...
		String patientName=URLEncoder.encode(pName, "UTF-8");
		RedirectView redirect=new RedirectView("/openmrs/module/mergePatient/list.form?patientName=" + patientName+"&DOB=" + DOB + "&gender=" + gender);
