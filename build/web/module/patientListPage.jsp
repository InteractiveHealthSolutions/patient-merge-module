...
<Table>
<tr>
<td><spring:message code="mergePatient.mergePatient.primaryPatient" />: </td>
...
<td><input name="searchButton" id="searchPatient" type="submit" value='<spring:message code="mergePatient.mergePatient.searchBtn" />'></td>
</tr>
</Table>
</form> 
...
<th><spring:message code="mergePatient.mergePatient.patientGender" /></th>
</tr>
</thead>
<tbody>
<c:forEach var="patient" items="${patientList}" varStatus="loop">
